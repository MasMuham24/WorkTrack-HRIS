...
<body class="h-full text-slate-800 antialiased selection:bg-indigo-500 selection:text-white"
    ...
    <div class="min-h-full flex">
        <!-- Sidebar -->
        <aside
            class="bg-white w-64 border-r border-slate-200 hidden md:block flex-shrink-0 flex-col h-screen sticky top-0">
        ...
        <div x-show="sidebarOpen" class="fixed inset-0 bg-slate-900/50 z-40 md:hidden"
        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <!-- Topbar -->
            <header
                class="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-10 sticky top-0">
                <div class="flex items-center">
                    <button @click="sidebarOpen = true"
                        class="md:hidden text-slate-500 hover:text-slate-700 focus:outline-none mr-4">
                        <i data-feather="menu" class="w-6 h-6"></i>
                    </button>
                    <h1 class="text-xl font-semibold text-slate-800 hidden sm:block">@yield('header_title', 'Dashboard')
                    </h1>
                </div>
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen"
                            ...
                            <a href="{{ route('profile.edit') }}#password-section"
                                class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">Ganti Password</a>
